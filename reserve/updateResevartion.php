...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto my-8 p-8 bg-white shadow-md rounded-md max-w-md">
        <h1 class="text-2xl text-center font-semibold mb-6">Update Reservation</h1>
        <div id="success-message" class="hidden mb-4 col-span-2 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-md">
            Update Reservation successful! Terima kasih atas pemesanannya.
        </div>
        <form action="../Controller/UpdateReserveController.php" method="post" class="grid grid-cols-2 gap-4">
